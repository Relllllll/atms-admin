    ...
    const unsubscribe = onValue(
      ...
      (snapshot) => {
        ...
        if (employeesData) {
          ...
          for (const employeeId in employeesData) {
            ...
            for (const date in attendance) {
              ...
              const logEntry = {
                ...
                timeIn: timeIn ? new Date(timeIn).toLocaleTimeString() : "-----",
          ...
          newLogs.sort((a, b) => {
            if (a.date === b.date) {
              return new Date(`${b.date} ${b.timeIn}`).getTime() - new Date(`${a.date} ${a.timeIn}`).getTime();
            }
          ...
          const paginatedLogs = newLogs.slice(offset, offset + itemsPerPage);
